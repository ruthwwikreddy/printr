...
export default function CustomerKioskRoot() {
    ...
    <div className="terminal-app-root">
        ...
        <div className="header-inner">
          <div className="header-brand">
            ...
            <div className="brand-titles">
              ...
              <span className="brand-sub-title">
                {shop.tagline || 'Automated Self-Service Printing Station'}
              </span>
            </div>
          </div>
          ...
          <div className="header-actions">
            <div className="status-pill-live">
              ...
              <span className="live-text">Printer Ready</span>
            </div>
            <Link href="/admin" className="header-admin-link">
              <SlidersHorizontal size={13} />
              <span>Shop Admin</span>
            </Link>
            <Link href="/landing" className="header-about-link" title="About Printr OS">
              <Sparkles size={13} />
              <span>About Printr</span>
            </Link>
          </div>
        </div>
      </header>
      ...
      <main className="terminal-main">
        ...
        <div className="terminal-stepper">
          ...
          <div className={`step-item ${step === 'configure' ? 'active' : ['payment', 'status'].includes(step) ? 'completed' : ''}`}>
            ...
            <span className="step-label">Print Options</span>
          </div>
          <div className="step-divider"></div>
          ...
          <div className={`step-item ${step === 'status' ? 'active' : ''}`}>
            ...
            <span className="step-label">Live Dispatch</span>
          </div>
        </div>
        ...
        {step === 'upload' && (
          <div className="terminal-card">
            <div className="card-header-clean">
              <h2 className="card-title">Select Document to Print</h2>
              <p className="card-desc">
                Upload your PDF or photos. Pages are calculated automatically in seconds.
              </p>
            </div>
            ...
            >
              {isUploading ? (
                ...
                <label className="dropzone-label">
                  ...
                  <span className="btn-browse-file">Choose File from Phone / PC</span>
                </label>
              )}
            </div>
        ...
        {step === 'configure' && fileDetails && (
          <div className="terminal-card">
            ...
            <div className="options-layout">
              ...
              <div className="option-field-group">
                <label className="field-label">
                  Your Phone Number <span className="label-hint">(Optional for order tracking)</span>
                </label>
                <input
                  type="tel"
        ...
        {step === 'payment' && orderInfo && (
          <div className="terminal-card">
            <div className="card-header-clean text-center">
              ...
              <p className="card-desc">
                Scan with any UPI app (GPay, PhonePe, Paytm, BHIM, Cred) to trigger automated printing.
              </p>
            </div>
            ...
            <div className="payment-qr-container">
              ...
              <div className="payment-meta-details">
                <div className="meta-line">
                  <span className="meta-label">Pay Direct To:</span>
                ...
                <div className="node-content">
                  ...
                  <span className="node-desc">
                    {orderStatus.jobStatus === 'COMPLETED'
                      ...
                      : 'Pages are ejecting from the printer tray.'}
                  </span>
                </div>
              </div>
            </div>
      ...
      <footer className="terminal-footer">
        <div className="footer-inner">
          <span>Powered by <strong>Printr Open-Source Autonomous Printing OS</strong></span>
          <span>·</span>
          <Link href="/admin">Shop Admin Panel</Link>
          <span>·</span>
          <Link href="/landing">System Architecture</Link>
        </div>
      </footer>
    </div>
  );
